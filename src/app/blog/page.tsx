...
export default async function BlogPage() {
  ...
  return (
    <main className="mx-auto px-8 max-sm:px-5" style={{ maxWidth: '680px', paddingTop: '4.5rem', paddingBottom: '4rem' }}>
      <p style={{ fontFamily: 'var(--font-ui)', fontSize: '0.65rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: 'var(--crimson)', marginBottom: '1.2rem' }}>
        All Writing
      </p>
      <h1
        className="mb-4 leading-[1.12]"
        style={{ fontFamily: 'var(--font-display)', fontWeight: 300, fontSize: 'clamp(2.2rem, 4vw, 3.2rem)', color: 'var(--ink)' }}
      >
        Notes from the long way home.
      </h1>
      <p className="mb-14" style={{ fontSize: '1.05rem', color: 'var(--ink-muted)', lineHeight: 1.8 }}>
        Essays on Catholic theology, family formation, and the convert&apos;s journey — worked through in public, one question at a time.
      </p>
