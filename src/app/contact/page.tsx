...
export const metadata: Metadata = {
  title: 'Contact',
  description: 'Get in touch with Mark DeKraker — theology, family formation, books, or just to say hello.',
}
    ...
    <main>
      ...
      <div
        ...
        <div
          ...
          <div
            ...
            <ul style={{ listStyle: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              {[
                { label: 'Theology & conversion', note: 'Questions, pushback, resonance' },
                { label: 'Family & parenting', note: 'Passing faith to young children' },
                { label: 'Books & reading', note: 'Recommendations always welcome' },
                { label: 'Catholic intellectual life', note: 'Newman, Aquinas, the whole tradition' },
              ].map(({ label, note }) => (
                <li key={label}>
                  <span
                    style={{
            ...
            <div style={{ marginTop: '2.5rem', paddingTop: '2rem', borderTop: '1px solid var(--rule)' }}>
              <p
                style={{
                  fontFamily: 'var(--font-ui)',
                  fontSize: '0.78rem',
        ...
        <div
          ...
          style={{ marginTop: '3rem', paddingTop: '2rem', borderTop: '1px solid var(--rule)' }}>
          <p
            style={{
              fontFamily: 'var(--font-ui)',
              fontSize: '0.78rem',
